...
ところで、[PHP 8.0 のバイナリを公式提供しないなんていう記事](https://forest.watch.impress.co.jp/docs/news/1264900.html) が 7 月くらいにあって当時驚いていたけど、普通に出ているのよね…これとは違うのかしら。
...
PHP 8.0.0 の正式リリース自体は 2020/11/26 なので、本当はプレリリースビルドである可能性があります…。あとでビルド記事を作るかも。
